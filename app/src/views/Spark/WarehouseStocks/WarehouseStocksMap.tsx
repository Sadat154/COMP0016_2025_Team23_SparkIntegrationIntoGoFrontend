    ...
    const bubbleGeoJson: BubbleFC = useMemo(() => {
        ...
        data.forEach((row) => {
            ...
            if (!current) {
                ...
                if (typeof explicitCount === 'number') {
                    const baseCount = current.warehousesCount ?? 0;
                    current.warehousesCount = baseCount + explicitCount;
        ...
        perIso3.forEach((v, iso3) => {
            ...
            const warehouseCount = typeof v.warehousesCount === 'number'
                ? v.warehousesCount
                : v.warehouses?.size ?? 0;
